...
export const products = {
    productList: 'flex flex-wrap g-4 mt-4',
    product: 'flex g-6 bg-[#fff] p-6 rounded-[0.8rem]',
    productCol: 'flex flex-col justify-between g-4',
    productDesc: 'flex flex-col g-4',
    productDescHeader: 'flex justify-between',
    productName: 'font-semibold',
    productPrice: 'font-semibold text-[#D99C70]',
    productDescText: 'text-black/80 overflow-hidden max-w-[200px] break-words',
    productBtn: 'rounded-[0.4rem] p-2 border-solid border-2 border-[#E6D9C9] bg-none text-[#D99C70] font-medium',
    productCount: 'flex items-center justify-around g-2 rounded-[0.4rem] p-2 bg-[#f6f6f6]',
